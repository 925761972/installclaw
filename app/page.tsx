...
export default function HomePage() {
  return (
    <><Header /><main>
      ...
      <section className="invite-cta-strip">
        <div className="invite-cta-inner">
          <div className="invite-cta-copy">
            <span className="invite-cta-badge">
              <span className="invite-cta-badge-dot" />
              邀请好友，免费赚积分
            </span>
            <h3>每邀请 <strong>1</strong> 位好友，双方各得 <strong>100</strong> 积分</h3>
            <p>无邀请上限。邀请 10 人 = 1000 积分 ≈ 10 分钟标准版处理 · 邀请 30 人 ≈ 轻量包免费 · 邀请 100 人 ≈ 创作包免费</p>
            <Link className="button button-light button-small" href="/register">免费注册开始邀请 <ArrowRight size={15} /></Link>
          </div>
          <div className="invite-cta-math">
            <div className="invite-cta-math-card">
              <span className="invite-cta-math-label">邀请 1 人</span>
              <strong>100</strong>
              <small>积分</small>
            </div>
            <div className="invite-cta-math-plus">+</div>
            <div className="invite-cta-math-card">
              <span className="invite-cta-math-label">邀请 3 人</span>
              <strong>300</strong>
              <small>积分 + 额外 100</small>
            </div>
            <div className="invite-cta-math-plus">+</div>
            <div className="invite-cta-math-card">
              <span className="invite-cta-math-label">邀请 5 人</span>
              <strong>500</strong>
              <small>积分 + 额外 200</small>
            </div>
          </div>
        </div>
      </section>
